<!DOCTYPE html>
<!-- This page allow someone to create an account. Anyone can create a simple user account.
An admin user (connected) has the possibility to create an account and choose if it'll be an admin account or not. -->
<html lang="en">
