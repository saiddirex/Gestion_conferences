	...
	<div class="inner-footer" >
			...
			<div class="row">
				<div class="row">
					<div class="col-md-4 f-about">
						<a href="#">
							<h1><span style="color: #ED502E"><?php echo $GestionDeConference; ?></h1>
						</a>
					...
					<div class="col-md-6 f-contact">
						<h3 class="widgetheading"><?php echo $Nous_contacter ?></h3>
		...
		<div class="last-div">
			<div class="container">
				<div class="row">
					<div class="copyright">
					<?php echo $copyright; ?> | <a href="http://www.isima.fr">ISIMA</a>
					</div>
